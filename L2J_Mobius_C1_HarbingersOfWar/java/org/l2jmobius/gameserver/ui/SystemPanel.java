...
public class SystemPanel extends JPanel
{
	...
	public SystemPanel()
	{
		...
		new Timer().schedule(new TimerTask()
		{
			...
			public void run()
			{
				lblProtocol.setText("Protocol: " + Config.CLIENT_PROTOCOL_VERSION);
			}
		}, 4500);
